...
assert(baseUi.includes(".hero-panel.registration-mode .arena-title{width:215px;max-width:72%;margin:0 auto;transform:none}"));
assert(baseUi.includes(".hero-panel.registration-mode .arena-heading{min-height:88px;margin:0 0 -2px}"));
