...
assert(baseUi.includes('body[data-arena-phase="registration"] .arena-heading .arena-title h1{'));
assert(baseUi.includes('body[data-arena-phase="registration"] .arena-heading .arena-title .arena-mark,'));
assert(baseUi.includes('"status logo host"'));
assert(baseUi.includes("#hero.asset-panel-stats.live-dashboard{"));
assert(baseUi.includes('body[data-arena-phase="registration"] .arena-heading .arena-live-logo{'));
assert(baseUi.includes('body[data-arena-phase="registration"] .arena-heading .status-line{\n  display:none;'));
assert(baseUi.includes('body[data-arena-phase="registration"] #stateBadge{'));
assert(baseUi.includes("width:96px;"));
assert(baseUi.includes('body[data-arena-phase="registration"] .topline{'));
assert(baseUi.includes("right:0;\n  bottom:0;"));
assert(baseUi.includes("transform:none;"));
assert(baseUi.includes('body[data-arena-phase="registration"] .arena-heading .arena-title{width:215px;max-width:72%;margin:0 auto;transform:none}'));
assert(baseUi.includes('body[data-arena-phase="registration"] .arena-heading{min-height:88px;margin:0 0 -2px}'));
assert(baseUi.includes('body[data-arena-phase="registration"] .topline .brand{'));
assert(baseUi.includes("display:none;"));
assert(baseUi.includes('body[data-arena-phase="registration"] .arena-heading{\n  position:relative;\n  z-index:2;\n  display:grid;'));
assert(baseUi.includes('body[data-arena-phase="registration"] .arena-heading .arena-live-logo{width:100%;height:auto;max-height:96px}'));
...
assert(featurePackSource.includes('body[data-arena-phase="registration"] #connectionChip{position:absolute;left:50%;bottom:0;z-index:20;margin:0;transform:translateX(-50%)}'));
