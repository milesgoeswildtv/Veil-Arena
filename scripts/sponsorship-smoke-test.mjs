...
assert(baseUi.includes("/* LIVE EVENT: canonical visual owner. Keep responsive behavior inside this block. */"));
assert.equal(count(baseUi,".viewer-state-card{"),1);
assert.equal(count(baseUi,".viewer-state-card.live-compact{"),1);
