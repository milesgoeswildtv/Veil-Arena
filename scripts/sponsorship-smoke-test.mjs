...
assert(baseUi.includes("transform:translate(-12px,48px)"));
...
assert(productPassSource.includes("top:-66px;left:64px;width:96px;min-width:96px;min-height:30px;padding:0 7px;font-size:8px"));
