...
assert(baseUi.includes(".hero-panel.registration-mode .arena-heading{min-height:96px}"));
...
assert(featurePackSource.includes('body[data-arena-phase="registration"] #connectionChip{position:absolute;left:50%;bottom:6px;z-index:20;margin:0;transform:translateX(-50%)}'));
...
assert(prizePackSource.includes("margin:0 auto -10px"));
assert(prizePackSource.includes("margin:0 -3% -10px"));
