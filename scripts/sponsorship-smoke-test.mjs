...
assert(baseUi.includes('class="live-event-plate-slice"'));
assert(baseUi.includes('<img src="/telegram/NewEventBackgroundPlate.PNG" alt="">'));
assert(baseUi.includes(".live-event-row-top .live-event-plate-slice img{top:0}"));
assert(baseUi.includes(".live-event-row-bottom .live-event-plate-slice img{bottom:0}"));
...
assert(baseUi.includes("min-height:44px"));
