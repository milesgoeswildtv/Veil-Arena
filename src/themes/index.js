...
export function renderTemplate(template, values = {}) {
  return String(template || "").replaceAll("{killer}", values.killer || "Someone").replaceAll("{victim}", values.victim || "someone").replaceAll("{winner}", values.winner || "Someone").replaceAll("{loser}", values.loser || "someone").replaceAll("{third}", values.third || "someone else");
}
