export const SPONSOR_PANEL_CLIENT = String.raw`(() => {
  ...
  if (submit) submit.textContent = 'SAVE SPONSORSHIP';
  ...
  function paint(data){
    ...
    form.hidden = locked;
    status.textContent = locked ? 'SPONSORSHIPS LOCKED — ARENA STARTED' : 'OPTIONAL // EDITABLE UNTIL THE ARENA STARTS';
  }
  ...
  form?.addEventListener('submit', async e => {
    ...
    submit.disabled=true;status.textContent='SAVING SPONSORSHIP…';
    try{
