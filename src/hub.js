...
const RULES_GRAPHIC_URL = "https://raw.githubusercontent.com/milesgoeswildtv/Veil-Arena/main/assets/EBE8B324-DBA3-49C3-893A-F1E0DAE9FE10.png";
...
(()=>{
  ...
  function rulesView(){
    panel.innerHTML='<div class="hubHero"><div class="hubEyebrow">DWALLET ARENA</div><div class="hubBig">RULES</div><div class="muted" style="margin-top:6px">Full rules graphic plus the quick-reference version below.</div></div>'+
      '<div class="rulesGraphicWrap"><img class="rulesGraphic" src="${RULES_GRAPHIC_URL}" alt="DWallet Arena rules infographic" loading="lazy" decoding="async"></div>'+
