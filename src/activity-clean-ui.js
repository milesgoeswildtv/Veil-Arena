export function cleanActivityHtml(clientId, build, clientPath) {
...
<div class="app">
  ...
  <div class="connect"><b id="step">CLEAN CLIENT STARTING</b><strong id="channel">VOICE CHANNEL // CONNECTING</strong><p id="detail">Loading Discord's official Embedded App SDK.</p></div>
  <div class="grid">
    <section class="stage">
