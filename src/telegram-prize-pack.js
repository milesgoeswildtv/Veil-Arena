...
.arena-nav{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px;margin:0 0 10px;padding:4px;border:1px solid #4b355a;border-radius:14px;background:#08060ccf;box-shadow:0 8px 20px #0006;backdrop-filter:blur(12px)}
.arena-nav-button{position:relative;min-height:38px;border:1px solid transparent;border-radius:10px;background:transparent;color:#9f91aa;font:950 9px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.12em;cursor:pointer;transition:.16s ease}.arena-nav-button.active{color:#fff;border-color:#6c4581;background:linear-gradient(145deg,#39204a,#1a1023);box-shadow:inset 0 0 0 1px #ffffff0a,0 0 18px #a45cff22}.arena-nav-button:active{transform:scale(.98)}.arena-nav-count{display:none;position:absolute;right:8px;top:7px;min-width:17px;height:17px;padding:0 5px;border-radius:999px;background:#c45cff;color:#fff;font:950 8px/17px ui-monospace,monospace;letter-spacing:0}.arena-nav-count.show{display:block}
