...
.arena-nav{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));width:86%;max-width:620px;gap:4px;margin:-10px auto 4px;padding:2px;border:1px solid #4b355a;border-radius:11px;background:#08060ccf;box-shadow:0 6px 16px #0006;backdrop-filter:blur(12px)}
body[data-arena-phase="running"][data-arena-view="arena"] .arena-nav{margin-top:-30px}
.arena-nav-button{position:relative;min-height:30px;border:1px solid transparent;border-radius:8px;background:transparent;color:#9f91aa;font:950 8px/1 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.1em;cursor:pointer;transition:.16s ease}.arena-nav-button.active{color:#fff;border-color:#6c4581;background:linear-gradient(145deg,#39204a,#1a1023);box-shadow:inset 0 0 0 1px #ffffff0a,0 0 18px #a45cff22}.arena-nav-button:active{transform:scale(.98)}
body[data-arena-phase="registration"] .arena-nav{
  position:relative;
  top:auto;
  z-index:80;
  width:100%;
  ...
  border:0;
  border-radius:0;
  background:url("/telegram/crashout%20ui/PregameLobbyHeader.PNG") center/100% 100% no-repeat;
  box-shadow:none;
  backdrop-filter:none;
}
body[data-arena-phase="registration"] .arena-nav-button{
  height:34%;
  min-height:0;
  margin:0;
  padding:0 4px;
...
body[data-arena-phase="registration"] .arena-nav-button.active{
  color:#fff;
  border-color:#c66cff55;
  background:radial-gradient(circle at 50% 45%,#7d37a63a 0,#4d205c22 58%,transparent 78%);
  box-shadow:inset 0 0 18px #c45cff1f,0 0 12px #8f48ca18;
}
body[data-arena-phase="registration"] .arena-nav-count{right:7%;top:12%}
.arena-nav-count{display:none;position:absolute;right:8px;top:7px;min-width:17px;height:17px;padding:0 5px;border-radius:999px;background:#c45cff;color:#fff;font:950 8px/17px ui-monospace,monospace;letter-spacing:0}.arena-nav-count.show{display:block}
...
body[data-arena-view="arena"] #featureGrid{display:none}body[data-arena-view="arena"] .sponsor-screen{display:none}body[data-arena-view="sponsor"] .main-grid,body[data-arena-view="sponsor"] .roster-panel,body[data-arena-view="sponsor"] .footer-row,body[data-arena-view="sponsor"] #featureGrid,body[data-arena-view="sponsor"] #reactionBar{display:none}body[data-arena-view="sponsor"] .sponsor-screen{display:block}body[data-arena-view="more"] .main-grid,body[data-arena-view="more"] .roster-panel,body[data-arena-view="more"] .footer-row,body[data-arena-view="more"] .sponsor-screen,body[data-arena-view="more"] #reactionBar{display:none}body[data-arena-view="more"] #featureGrid{display:grid}
@media(max-width:760px){.arena-nav{position:sticky;top:max(4px,env(safe-area-inset-top));z-index:80;margin-top:-12px}body[data-arena-phase="registration"] .arena-nav{position:relative;top:auto;width:100%;margin:-34px auto -66px}body[data-arena-phase="running"][data-arena-view="arena"] .arena-nav{margin-top:-34px}.sponsor-hero{border-width:13px;padding:17px}.sponsor-title{font-size:36px}.sponsor-metrics{gap:6px}.sponsor-metric{padding:10px 9px}.sponsor-metric strong{font-size:18px}}@media(max-width:440px){.arena-nav{width:84%;gap:3px;padding:2px;margin-top:-12px}body[data-arena-phase="registration"] .arena-nav{width:106%;margin:-32px -3% -64px;padding:0 7.6%;gap:1.6%}body[data-arena-phase="registration"] .arena-nav-button{height:34%;min-height:0;font-size:9px;letter-spacing:.07em}body[data-arena-phase="running"][data-arena-view="arena"] .arena-nav{margin-top:-38px}.arena-nav-button{min-height:28px;letter-spacing:.07em;font-size:8px}.sponsor-amount-row{grid-template-columns:minmax(0,1fr) 82px}.sponsor-card{padding:14px}.sponsor-top{display:block}.sponsor-status{display:inline-block;margin-top:7px}}
</style>`;
...
(() => {
  ...
  function installNavigation(){
    ...
    nav.innerHTML='<button class="arena-nav-button active" type="button" data-arena-view="arena">ARENA</button><button class="arena-nav-button" type="button" data-arena-view="sponsor">SPONSORS<span class="arena-nav-count" id="sponsorNavCount">0</span></button><button class="arena-nav-button" type="button" data-arena-view="more">MORE</button>';
