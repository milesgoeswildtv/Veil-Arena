...
@media(max-width:760px){.arena-nav{position:sticky;top:max(4px,env(safe-area-inset-top));z-index:80;margin-top:-12px}body[data-arena-phase="registration"] .arena-nav{position:relative;top:auto;width:100%;margin:-28px auto -82px}body[data-arena-phase="running"][data-arena-view="arena"] .arena-nav{margin-top:-34px}.sponsor-hero{border-width:13px;padding:17px}.sponsor-title{font-size:36px}.sponsor-metrics{gap:6px}.sponsor-metric{padding:10px 9px}.sponsor-metric strong{font-size:18px}}@media(max-width:440px){.arena-nav{width:84%;gap:3px;padding:2px;margin-top:-12px}body[data-arena-phase="registration"] .arena-nav{width:106%;margin:-26px -3% -78px;padding:0 7.6%;gap:1.6%}body[data-arena-phase="registration"] .arena-nav-button{height:34%;min-height:0;font-size:9px;letter-spacing:.07em}body[data-arena-phase="running"][data-arena-view="arena"] .arena-nav{margin-top:-38px}.arena-nav-button{min-height:28px;letter-spacing:.07em;font-size:8px}.sponsor-amount-row{grid-template-columns:minmax(0,1fr) 82px}.sponsor-card{padding:14px}.sponsor-top{display:block}.sponsor-status{display:inline-block;margin-top:7px}}
</style>`;
