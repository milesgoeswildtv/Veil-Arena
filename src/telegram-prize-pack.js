...
body[data-arena-view="arena"] #featureGrid{display:none}body[data-arena-view="arena"] .sponsor-screen{display:none}body[data-arena-view="sponsor"] .main-grid,body[data-arena-view="sponsor"] .roster-panel,body[data-arena-view="sponsor"] .footer-row,body[data-arena-view="sponsor"] #featureGrid,body[data-arena-view="sponsor"] #reactionBar{display:none}body[data-arena-view="sponsor"] .sponsor-screen{display:block}body[data-arena-view="more"] .main-grid,body[data-arena-view="more"] .roster-panel,body[data-arena-view="more"] .sponsor-screen,body[data-arena-view="more"] #reactionBar{display:none}body[data-arena-view="more"] #featureGrid{display:grid}
