...
body:is([data-arena-phase="registration"],[data-arena-phase="running"]) .arena-nav{
  position:relative;
  top:auto;
  z-index:80;
  width:100%;
...
body:is([data-arena-phase="registration"],[data-arena-phase="running"]) .arena-nav-button{
  height:34%;
  min-height:0;
  margin:0;
  padding:0 4px;
...
body:is([data-arena-phase="registration"],[data-arena-phase="running"]) .arena-nav-button.active{
  color:#fff;
...
body:is([data-arena-phase="registration"],[data-arena-phase="running"]) .arena-nav-count{right:7%;top:12%}
...
@media(max-width:760px){.arena-nav{position:sticky;top:max(4px,env(safe-area-inset-top));z-index:80;margin-top:-12px}body:is([data-arena-phase="registration"],[data-arena-phase="running"]) .arena-nav{position:relative;top:auto;width:100%;margin:-28px auto -82px}.sponsor-hero{border-width:13px;padding:17px}.sponsor-title{font-size:36px}.sponsor-metrics{gap:6px}.sponsor-metric{padding:10px 9px}.sponsor-metric strong{font-size:18px}}@media(max-width:440px){.arena-nav{width:84%;gap:3px;padding:2px;margin-top:-12px}body:is([data-arena-phase="registration"],[data-arena-phase="running"]) .arena-nav{width:106%;margin:-26px -3% -78px;padding:0 7.6%;gap:1.6%}body:is([data-arena-phase="registration"],[data-arena-phase="running"]) .arena-nav-button{height:34%;min-height:0;font-size:9px;letter-spacing:.07em}.arena-nav-button{min-height:28px;letter-spacing:.07em;font-size:8px}.sponsor-amount-row{grid-template-columns:minmax(0,1fr) 82px}.sponsor-card{padding:14px}.sponsor-top{display:block}.sponsor-status{display:inline-block;margin-top:7px}}
</style>`;
