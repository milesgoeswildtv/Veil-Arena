...
(() => {
  ...
  function renderFeaturePack(){
    ...
    appendMainControls(); renderHostTools(); renderHistory(); renderRecap(); renderReactions(); renderDiagnostics();
